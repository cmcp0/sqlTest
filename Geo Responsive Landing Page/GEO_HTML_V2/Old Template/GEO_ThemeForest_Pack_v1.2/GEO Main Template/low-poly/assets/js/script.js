...
// --------------Trianglify background------------------
 ...
 var tri = new Trianglify({
  x_gradient: Trianglify.colorbrewer.Blues[9],
  noiseIntensity: 0
 });

 var pattern = tri.generate($('.banner-area').width(), $('.banner-area').height());
 $('.banner-area').css('background-image', pattern.dataUrl);
 $('.feature-area').css('background-image', pattern.dataUrl);
 $('.counter-area').css('background-image', pattern.dataUrl);
 $('.video-area').css('background-image', pattern.dataUrl);
 $('.review').css('background-image', pattern.dataUrl);
 $('.downlaod').css('background-image', pattern.dataUrl);
 $('.subscribe-area').css('background-image', pattern.dataUrl);
 $('.footer-area').css('background-image', pattern.dataUrl);
